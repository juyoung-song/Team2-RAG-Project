...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/RAG-4169E1?style=for-the-badge&logo=octopusdeploy&logoColor=white">
</div>


## 🏗️ 프로젝트 구조 (Project Structure)
```text
├── .github/              # GitHub Action(CI/CD) 및 PR 템플릿 설정
├── data/                 
│   └── raw/              # 원본 문서
├── src/                  # 메인 소스 코드
├── notebooks/            # EDA, 데이터 분석 및 프롬프트 테스트 기록
├── tests/                # 단위 테스트 및 RAGAS 기반 성능 측정
└── .env.example          # API Key 공유용 템플릿
